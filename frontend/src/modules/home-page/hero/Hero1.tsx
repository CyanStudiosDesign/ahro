...
export const HeroSection: React.FC<HeroSectionProps> = ({ data }) => {
  ...
  return (
    <section className="relative flex h-svh w-full flex-col overflow-hidden bg-ink font-sans text-white lg:h-screen">
      ...
      {/* Wider cap + steadily growing padding (no shrink at xl) so big screens don't get a huge dead gutter */}
      <div className="relative z-20 mx-auto flex h-full w-full max-w-[110rem] items-center px-5 pb-8 pt-24 md:px-10 md:pb-10 md:pt-28 lg:px-14 lg:pb-12 lg:pt-32 xl:px-20 2xl:px-28">
        <main className="grid w-full grid-cols-1 items-center gap-12 lg:grid-cols-12 lg:gap-14 xl:gap-20 2xl:gap-24">
          {/* Left Column: Typography, CTA, Stats Badges */}
          <div className="space-y-8 lg:col-span-7 lg:space-y-9 xl:space-y-10">
            ...
            <div className="space-y-3">
              <TiltedCard rotateAmplitude={7} scaleOnHover={1.025}>
                <SplitText
                  as="h1"
                  splitBy="chars"
                  className="cursor-default font-heading text-[clamp(2rem,6vw,2.75rem)] font-bold leading-[1.08] tracking-[-0.02em] text-white drop-shadow-md lg:text-h1 xl:text-[3rem]"
                >
                  {mainHeading}
                </SplitText>
              </TiltedCard>
              <TiltedCard rotateAmplitude={6} scaleOnHover={1.02}>
                <SplitText
                  as="h2"
                  delay={0.12}
                  className="cursor-default font-heading text-[22px] font-bold leading-[1.2] tracking-[-0.005em] text-white/95 drop-shadow sm:text-[26px] lg:text-h2"
                >
                  {subHeading}
                </SplitText>
              </TiltedCard>
              <TiltedCard rotateAmplitude={5} scaleOnHover={1.015}>
                <AnimatedContent delay={0.2} distance={24}>
                  <BodyText className="cursor-default max-w-[36rem] pt-1 text-white/90 drop-shadow">
                    {description}
                  </BodyText>
                </AnimatedContent>
              </TiltedCard>
            ...
            {/* 1. Learn More Button (keeps pointer cursor — it's a real link) */}
            ...
            {/* 2. Stats Grid Section — now fills the column width instead of capping at 38rem */}
            <div className="grid w-full grid-cols-3 gap-4 pt-1 sm:gap-6 lg:gap-8 xl:gap-10">
              ...
              <div className="group flex h-full flex-col items-center gap-2 text-center sm:flex-row sm:gap-3 sm:text-left">
                ...
                <TiltedCard rotateAmplitude={6} scaleOnHover={1.04}>
                  <div className="cursor-default flex flex-col justify-center">
          ...
          <div className="hidden lg:col-span-5 lg:block">
            <TiltedCard className="ml-auto w-full max-w-md rounded-3xl border border-white/80 bg-surface/95 p-6 text-ink shadow-2xl backdrop-blur-md will-change-transform xl:p-8">
              <div className="[transform:translateZ(28px)]">
                <div className="mb-3 flex items-start justify-between gap-4">
                  <SplitText
                    as="h3"
                    delay={0.2}
                    className="cursor-default text-lg font-bold leading-snug font-heading text-ink"
                  >
                ...
                <p className="cursor-default mb-4 text-xs leading-relaxed text-slate-1 font-body">
